...
module.exports = (env, argv) => {
	...
	const projectConfig = {
		config: {
			...
			projectUrl: 'notimportant.test', // Used for providing browsersync functionality.
			projectPath: 'wp-content/themes/release-github-actions-test', // Project path relative to project root.
		},
	};
