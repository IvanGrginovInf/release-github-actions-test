 ...
 *
 * @package ReleaseGithubActionsTest\Config
 */

declare(strict_types=1);

namespace ReleaseGithubActionsTest\Config;

use ReleaseGithubActionsTestVendor\EightshiftLibs\Config\AbstractConfigData;
