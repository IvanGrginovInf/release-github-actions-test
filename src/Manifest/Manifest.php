 ...
 *
 * @package ReleaseGithubActionsTest\Manifest
 */

declare(strict_types=1);

namespace ReleaseGithubActionsTest\Manifest;

use ReleaseGithubActionsTest\Config\Config;
use ReleaseGithubActionsTestVendor\EightshiftLibs\Manifest\AbstractManifest;
