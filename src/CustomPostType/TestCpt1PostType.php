...
/**
 * File that holds class for TestCpt1PostType custom post type registration.
 *
...
/**
 * Class TestCpt1PostType.
 */
class TestCpt1PostType extends AbstractPostType
{
	 ...
	 * @var string
	 */
	public const POST_TYPE_SLUG = 'test-cpt-1';
	 ...
	 * @var string
	 */
	public const POST_TYPE_URL_SLUG = 'test-cpt-1';
	 ...
	 * @var string
	 */
	public const REST_API_ENDPOINT_SLUG = 'test-cpt-1';
	...
	{
		return [
			'label' => \esc_html__('Test CPT 1', 'test-theme'),
			'public' => true,
