...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	...
	return (
		<>
			{!wrapperDisable &&
				<PanelBody title={<span>{__('Block Layout', 'test-theme')}</span>} initialOpen={false} icon={icons.wrapper} className={'es-panel-title'}>
					...
					{wrapperUseShowControl &&
						<ToggleControl
							label={wrapperUse ? __('Wrapper Enabled', 'test-theme') : __('Wrapper Disabled', 'test-theme')}
							checked={wrapperUse}
					...
					{(wrapperUse && wrapperUseSimpleShowControl) &&
						<ToggleControl
							label={wrapperUseSimple ? __('Wrapper Simple Enabled', 'test-theme') : __('Wrapper Simple Disabled', 'test-theme')}
							...
							{showWrapperSpacingBottomIn &&
								<Responsive
									label={
										<>
											<Icon icon={icons.spacingBottom} />
											{__('Spacing Bottom In', 'test-theme')}
										</>
									}
								>
										...
										<ColorPaletteCustom
											label={
												<>
													...
													{__('Background Color', 'test-theme')}
												</>
											}
