 ...
 *
 * @package ReleaseGithubActionsTest\Blocks
 */

declare(strict_types=1);

namespace ReleaseGithubActionsTest\Blocks;

use ReleaseGithubActionsTest\Config\Config;
use ReleaseGithubActionsTestVendor\EightshiftLibs\Blocks\AbstractBlocks;
